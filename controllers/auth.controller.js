...
exports.getLoginPage = (req, res) => {
    if (req.isAuthenticated()) return res.redirect("/sa/techboard/admin");
...
exports.postSignup = async (req, res) => {
    try {
        ...
        return res.redirect("/sa/techboard/admin/signup");
        }
...
exports.changeAdmin = async (req, res) => {
    try {
      ...
      if (!user) {
        ...
        return res.redirect("/sa/techboard/admin/users");
      }
...
exports.deleteUser = async (req, res) => {
    try {
      ...
      res.redirect("/sa/techboard/admin/users");
    } catch (error) {
      console.log(error.message);
      return res.redirect("/sa/techboard/admin");
    }
